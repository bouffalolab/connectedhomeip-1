...
// ------------------------------------------------------------ 
// Dac CERTIFICATE ./attestation//Chip-Bouffalolab-DAC-FFF1-8005-0000-Cert.der 

constexpr uint8_t Dac_Cert_Array[] = {
    0x30, 0x82, 0x01, 0xe1, 0x30, 0x82, 0x01, 0x87, 0xa0, 0x03, 0x02, 0x01, 0x02, 0x02, 0x08, 0x7b,
    0x57, 0xfb, 0x10, 0x2e, 0x01, 0x0a, 0xb4, 0x30, 0x0a, 0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d,
    ...
    0x30, 0x35, 0x30, 0x59, 0x30, 0x13, 0x06, 0x07, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x02, 0x01, 0x06,
    0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07, 0x03, 0x42, 0x00, 0x04, 0xbf, 0x6c, 0x54,
    0xa1, 0xfa, 0xaf, 0x53, 0x5b, 0xa6, 0xe6, 0x88, 0xd8, 0x28, 0xa7, 0xc3, 0x01, 0x65, 0x56, 0xc7,
    0xd7, 0x4b, 0x7a, 0x3b, 0x1b, 0x73, 0x74, 0xff, 0x03, 0x2d, 0x57, 0xec, 0x49, 0x1f, 0xd1, 0x9c,
    0x09, 0x7e, 0xb5, 0x17, 0x7d, 0x27, 0xf8, 0xb4, 0x4d, 0x73, 0x95, 0xa9, 0xfa, 0xd0, 0x42, 0xb9,
    0x33, 0xb0, 0x29, 0xac, 0x13, 0x86, 0xd8, 0xab, 0xf6, 0x90, 0x01, 0xdc, 0xdc, 0xa3, 0x60, 0x30,
    ...
    ,
};

ByteSpan kDacCert = ByteSpan(Dac_Cert_Array);

// Dac PUBLIC KEY FROM ./attestation//Chip-Bouffalolab-DAC-FFF1-8005-0000-Key.pem 

constexpr uint8_t Dac_PublicKey_Array[] = {
    0x04, 0xbf, 0x6c, 0x54, 0xa1, 0xfa, 0xaf, 0x53, 0x5b, 0xa6, 0xe6, 0x88, 0xd8, 0x28, 0xa7, 
    0xc3, 0x01, 0x65, 0x56, 0xc7, 0xd7, 0x4b, 0x7a, 0x3b, 0x1b, 0x73, 0x74, 0xff, 0x03, 0x2d, 
    0x57, 0xec, 0x49, 0x1f, 0xd1, 0x9c, 0x09, 0x7e, 0xb5, 0x17, 0x7d, 0x27, 0xf8, 0xb4, 0x4d, 
    0x73, 0x95, 0xa9, 0xfa, 0xd0, 0x42, 0xb9, 0x33, 0xb0, 0x29, 0xac, 0x13, 0x86, 0xd8, 0xab, 
    0xf6, 0x90, 0x01, 0xdc, 0xdc
};

ByteSpan kDacPublicKey = ByteSpan(Dac_PublicKey_Array);

// Dac PRIVATE KEY FROM ./attestation//Chip-Bouffalolab-DAC-FFF1-8005-0000-Key.pem 

constexpr uint8_t Dac_PrivateKey_Array[] = {
    0x60, 0x74, 0x8a, 0xef, 0xf4, 0xc5, 0xc8, 0x58, 0x4a, 0x49, 0xb8, 0x5d, 0xdc, 0xa6, 0xb4, 
    0x5e, 0x24, 0xec, 0xc1, 0xe0, 0xc4, 0xa7, 0xc3, 0xc6, 0x36, 0xba, 0x35, 0x41, 0x28, 0x39, 
    0xc6, 0x09
};
...
// ------------------------------------------------------------ 
// Dac CERTIFICATE ./attestation//Chip-Bouffalolab-DAC-FFF1-8005-0001-Cert.der 

constexpr uint8_t Dac_Cert_Array[] = {
    0x30, 0x82, 0x01, 0xe1, 0x30, 0x82, 0x01, 0x87, 0xa0, 0x03, 0x02, 0x01, 0x02, 0x02, 0x08, 0x02,
    0x7f, 0xc3, 0x42, 0x28, 0xc4, 0x6b, 0x94, 0x30, 0x0a, 0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d,
    0x04, 0x03, 0x02, 0x30, 0x37, 0x31, 0x1f, 0x30, 0x1d, 0x06, 0x03, 0x55, 0x04, 0x03, 0x0c, 0x16,
    0x4d, 0x61, 0x74, 0x74, 0x65, 0x72, 0x20, 0x42, 0x6f, 0x75, 0x66, 0x66, 0x61, 0x6c, 0x6f, 0x4c,
    0x61, 0x62, 0x20, 0x50, 0x41, 0x49, 0x31, 0x14, 0x30, 0x12, 0x06, 0x0a, 0x2b, 0x06, 0x01, 0x04,
    0x01, 0x82, 0xa2, 0x7c, 0x02, 0x01, 0x0c, 0x04, 0x46, 0x46, 0x46, 0x31, 0x30, 0x20, 0x17, 0x0d,
    ...
    ,
};

ByteSpan kDacCert = ByteSpan(Dac_Cert_Array);

// Dac PUBLIC KEY FROM ./attestation//Chip-Bouffalolab-DAC-FFF1-8005-0001-Key.pem 

constexpr uint8_t Dac_PublicKey_Array[] = {
    0x04, 0xf3, 0xd3, 0xf9, 0xf5, 0x80, 0x0b, 0x28, 0x41, 0xf1, 0x1c, 0xd6, 0xbb, 0x4a, 0x15, 
    0xb9, 0x74, 0x77, 0x9c, 0xed, 0x45, 0xb4, 0xe4, 0x88, 0x25, 0xe5, 0x0b, 0x20, 0x4b, 0xee, 
    0xda, 0x4c, 0x71, 0x16, 0xd4, 0x1c, 0xea, 0xfe, 0x20, 0x90, 0x27, 0x71, 0xdd, 0x1d, 0x2a, 
    0x74, 0x77, 0x4e, 0x48, 0x0f, 0xd0, 0xdd, 0x9b, 0xed, 0x28, 0x78, 0xbb, 0x45, 0xd0, 0xbf, 
    0xc7, 0xe2, 0xf3, 0xef, 0x82
};

ByteSpan kDacPublicKey = ByteSpan(Dac_PublicKey_Array);

// Dac PRIVATE KEY FROM ./attestation//Chip-Bouffalolab-DAC-FFF1-8005-0001-Key.pem 

constexpr uint8_t Dac_PrivateKey_Array[] = {
    0xd0, 0x86, 0x63, 0x8c, 0x53, 0x4d, 0x78, 0x24, 0xbd, 0xfb, 0x1a, 0x22, 0xa0, 0xde, 0xa0, 
    0xc4, 0x67, 0x71, 0x10, 0x08, 0x9e, 0x80, 0x6f, 0x7f, 0x04, 0xea, 0xc4, 0x3b, 0xd0, 0x4a, 
    0xfb, 0xf1
};
