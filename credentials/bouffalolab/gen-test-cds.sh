...
cd_signing_key="$dest_dir/../../test/certification-declaration/Chip-Test-CD-Signing-Key.pem"
cd_signing_cert="$dest_dir/../../test/certification-declaration/Chip-Test-CD-Signing-Cert.pem"
...
for cert_file_der in "$dest_dir"/*.der;
do
    xxd -i ${cert_file_der}
